...
set more off
* set matsize 5000
use c:/P1-Div/pwt1, clear
sort cnum year
save c:/P1-Div/pwt1, replace

use c:/P1-Div/allfactors_wide30, clear
...
use c:/P1-Div/meanlaborprod_wide30, clear
...
use c:/P1-Div/preparedshares30, clear
...
sort cnum year
save c:/P1-Div/specmeasures50, replace 


* now merge with stuff
use c:/P1-Div/wdinew, clear
keep cnum cname year rgdppcp pop 
sort cnum year
merge cnum year using c:/P1-Div/specmeasures50
drop _
sort cnum year
save c:/P1-Div/specmeasures50, replace
...
sort cnum year
save c:/P1-Div/meanlaborprod, replace
sum cnum
...
sort one
save c:/P1-Div/coefs_wide, replace

use c:/P1-Div/meanlaborprod, clear
drop b0 b1 b2
ren V ownV
...
gen one=1
sort one
merge one using c:/P1-Div/coefs_wide
tab _
keep if _==3
drop _
...
sort cnum year
merge cnum year using c:/P1-Div/pwt1
tab _
drop _
...
save c:/P1-Div/wdiilominimumvariance, replace
